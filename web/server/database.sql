...
CREATE TABLE intervencoes(id VARCHAR(255) NOT NULL,id_equipa VARCHAR(255) NOT NULL,acesso VARCHAR(255) NOT NULL,elemento VARCHAR(255) NOT NULL,conector INT NOT NULL,CONSTRAINT fk_equipa FOREIGN KEY(id_equipa) REFERENCES equipas(id), PRIMARY KEY(id));
